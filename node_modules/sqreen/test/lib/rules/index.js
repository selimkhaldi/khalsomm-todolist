...
describe('Rules', () => {
    ...
    describe('_getCallbacks', () => {
        ...
        it('should return a callback method', { plan: 2 }, (done) => {
            ...
            expect(result.pre).to.not.exist();
            expect(result.post).to.exist();
    ...
    describe('_collectHookPointsInstructions', () => {
        ...
        it('should collect a list of hookpoints', { plan: 6 }, (done) => {
                ...
                const MockedRules = Proxyquire('../../../lib/rules/index', {
                    ...
                    '../instrumentation/director': {
                        update: function (payload) {
                            ...
                            expect(payload.params.postCbs).to.be.an.array();
