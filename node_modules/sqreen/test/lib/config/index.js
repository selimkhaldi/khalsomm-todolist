...
describe('Config', () => {
    ...
    describe('parseConfig', () => {
        ...
        it('should not change anything to a good conf', { plan: 9 }, (done) => {
    ...
    describe('readConfig', () => {
        ...
        it('should read the conf from a json file and env variables', { plan: 2 }, (done) => {

            const toWrite = { url: 'http://back2.sqreen.io', token: 'token' };
        ...
        it('should read the conf from env variables', { plan: 9 }, (done) => {
