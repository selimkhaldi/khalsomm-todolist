...
describe('Command', () => {
    ...
    describe('features', () => {
        ...
        it('should change the features', { plan: 8 }, (done) => {
            ...
            const Features = Proxyquire('../../../lib/command/features', {
                ...
                '../agent': {
                    ...
                    metricLoopStarter: function (value) {
        ...
        it('should change the features and disable batch', { plan: 6 }, (done) => {
