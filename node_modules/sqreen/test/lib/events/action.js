...
describe('Event.action', () => {
    ...
    describe('trigger', () => {
        ...
        it('should should put back an event that could not be reported', { plan: 3, timeout: 30000 }, () => {
            ...
            const t0 = new Date();
            return MockedAction.trigger(queue, 1)
                .then(() => {

                    const t1 = new Date();
                    expect(t1 - t0).to.be.at.least(1);
                    expect(t1 - t0).to.be.below(20000);
