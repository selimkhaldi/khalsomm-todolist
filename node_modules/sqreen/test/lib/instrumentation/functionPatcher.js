...
const Director = require('../../../lib/instrumentation/director');
// TODO: test all functions definitions
describe('functionPatcher', () => {

    describe('_runCbs', () => {

        it('should collect the result of the pre', { plan: 1 }, (done) => {
    ...
    describe('patchFunction', () => {
        ...
        it('update a function and hijack its return value at pre', { plan: 3 }, (done) => {
        ...
        it('update a function and raise its return value at fail', { plan: 1 }, (done) => {
        ...
        it('should try to patch native code', { plan: 1 }, (done) => {
