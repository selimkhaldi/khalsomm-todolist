...
const PATH_DIRECTOR = '../../../lib/instrumentation/director';
...
describe('Director', () => {
    ...
    beforeEach((done) => {
        ...
        Decache(PATH_DIRECTOR);
        Director = require(PATH_DIRECTOR);
        done();
    });
    ...
    describe('update', () => {
        ...
        it('should not call if the version is wrong', { plan: 2 }, (done) => {

            const caller = { moduleName: 'moduleName', methodName: 'methodName', versions: '> 2.0.0', params: 'hello' };
            const fct = function () {};
            Director.register({ moduleName: 'moduleName', methodName: 'methodName', version:'1.0.0', updateCallback: fct });
            try {
                ...
                expect(err).to.exist();
                expect(err.message).to.equal(`module ${caller.moduleName} versions ${['1.0.0']} are present and none satisfies ${caller.versions}`);
                done();
            }
        });

        it('should not call if the module is not instrumented', { plan: 2 }, (done) => {
            ...
            try {
                ...
                expect(err).to.exist();
                expect(err.message).to.equal(`module ${caller.moduleName} is not instrumented`);
                done();
            }
        });
        ...
        it('should actionnate an unnamed registered script', { plan: 2 }, (done) => {
            ...
            const caller = { moduleName: 'moduleName', params: 'hello' };
            const fct = function (params) {
        ...
        it('should actionnate a registered script after passing in the waiting list', { plan: 2 }, (done) => {
            ...
            const caller = { moduleName: 'moduleName_unique', file: 'index.js', methodName: 'methodName', versions: '', params: 'hello' };
            const fct = function (params) {
